...
class UserData:
    ...
    def __leetcode(self):
        ...
        get_easy_questions = driver.find_element_by_xpath(
            '/html/body/div[1]/div[2]/div/div[1]/div[2]/div/div[2]/div/div[1]/div[2]').text
        easy_questions_solved, total_easy_questions = get_easy_questions.split('/')

        get_medium_questions = driver.find_element_by_xpath(
            '/html/body/div[1]/div[2]/div/div[1]/div[2]/div/div[2]/div/div[2]/div[2]').text
        medium_questions_solved, total_medium_questions = get_medium_questions.split('/')

        get_hard_questions = driver.find_element_by_xpath(
            '/html/body/div[1]/div[2]/div/div[1]/div[2]/div/div[2]/div/div[3]/div[2]').text
